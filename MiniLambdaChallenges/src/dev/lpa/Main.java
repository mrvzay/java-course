...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        printWordsForEach.accept("Let's split has up into an array");

        Consumer<String> printWordsConcise = setence -> {
            Arrays.asList(setence.split(" ")).forEach(s -> System.out.println(s));
        };

        printWordsConcise.accept("Let's split has ito an array");
